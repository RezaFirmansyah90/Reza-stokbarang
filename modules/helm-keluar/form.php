...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Input Data Helm Keluar
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=beranda"><i class="fa fa-home"></i> Beranda </a></li>
      <li><a href="?module=helm_keluar"> Helm Keluar </a></li>
        ...
        <div class="box box-primary">
          ...
          <form role="form" class="form-horizontal" action="modules/helm-keluar/proses.php?act=insert" method="POST" name="formObatKeluar">
            <div class="box-body">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Helm</label>
                <div class="col-sm-5">
                  <select class="chosen-select" name="kode_helm" data-placeholder="-- Pilih Helm --" onchange="tampil_helm(this)" autocomplete="off" required>
                    <option value=""></option>
                    <?php
