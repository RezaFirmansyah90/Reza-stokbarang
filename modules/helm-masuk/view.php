...
<section class="content-header">
  <h1>
    <i class="fa fa-sign-in icon-title"></i> Data Helm Masuk
  ...
  <div class="row">
    ...
    elseif ($_GET['alert'] == 1) {
      echo "<div class='alert alert-success alert-dismissable'>
              ...
              Data Helm Masuk berhasil disimpan.
            </div>";
    }
    ?>
        ...
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT a.kode_transaksi,a.tanggal_masuk,a.kode_helm,a.jumlah_masuk,b.kode_helm,b.nama_helm,b.satuan
                                            FROM is_obat_masuk as a INNER JOIN is_helm as b ON a.kode_helm=b.kode_helm ORDER BY kode_transaksi DESC")
