...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Login | Denis Motor</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Aplikasi Stok Barang Denis Motor">
    <meta name="author" content="Reza Firmansyah" />

    <!-- favicon -->
    <link rel="shortcut icon" href="assets/img/denismotor2.png" />
  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#DC143C" class="login-logo">
        <img style="margin-top:-12px" src="assets/img/denismotor1.png" alt="Logo" height="50"> <b>DENIS MOTOR</b>
      </div><!-- /.login-logo -->
      <?php  
