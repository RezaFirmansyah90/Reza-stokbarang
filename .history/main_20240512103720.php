...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | DENIS MOTOR</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          ...
          <span style="font-size:25px">DENIS MOTOR</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2024 - <a href="https://textcode.blogspot.com">Reza Firmansyah</a></strong>
      </footer>
    </div><!-- ./wrapper -->
